...
public class TShirtRepositoryTest {
    ...
    public void shouldAddFindDeleteTShirt() {
        ...
        //Act
        tShirtRepository.deleteById(newTShirt.gettShirtId());
        Optional<TShirt> foundTShirt = tShirtRepository.findById(newTShirt.gettShirtId());
    ...
    public void shouldFindTShirtByColor(){
        ...
        //Act
        List<TShirt> foundNoTShirt = tShirtRepository.findAllTShirtsByColor("InvalidValue");

        List<TShirt> foundOneTShirt = tShirtRepository.findAllTShirtsByColor("SkyBlue");

        List<TShirt> foundTwoTShirt = tShirtRepository.findAllTShirtsByColor("Pink");
    ...
    public void shouldFindTShirtBySize(){
        ...
        //Act
        List<TShirt> foundNoTShirt = tShirtRepository.findAllTShirtsBySize("InvalidValue");

        List<TShirt> foundOneTShirt = tShirtRepository.findAllTShirtsBySize("S");

        List<TShirt> foundTwoTShirt = tShirtRepository.findAllTShirtsBySize("L");
